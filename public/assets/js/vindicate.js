...
function vindicateForm(options) {
  ...
  this.options = $.extend(true, {
      ...
      formats: {
        ...
        minChars: {
          regex: /^.{4,}$/, 
          message: "This field requires a minimum of 4 characters."
        },
        languageID: {
          regex: /^[a-zA-Z]{1}[a-zA-Z0-9- ()!]{5,19}$/,
          message: "Invalid Language Name"
        },
        groupName: {
          regex: /^[a-zA-Z]{1}[a-zA-Z0-9- .()'"]{3,35}$/,
...
function vindicateField($element, formId, options) {
  ...
  this.validateFormat = function(options) {
    strict_validation = ["alpha", "alphanumeric", "minChars", "languageID", "groupName", "date", "decimal","email","numeric", "phone", "time", "url"]
